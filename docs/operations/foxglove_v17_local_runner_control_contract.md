# Foxglove V17 local Runner control contract
...
- request: `/hope/v17/runner/control_request_flat`;
- state: `/hope/v17/runner/state_flat`.
...
-> refresh_x_hit (telemetry, not a gate) -> enter_motion
