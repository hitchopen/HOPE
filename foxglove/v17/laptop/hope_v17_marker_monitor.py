...
from hope_v17_marker_monitor_core import (
    EXPECTED_P1_MARKERS,
...
class HopeV17MarkerMonitor(Node):
    def __init__(self) -> None:
        super().__init__("hope_v17_marker_monitor", start_parameter_services=False)
        ...
        self._pub_count = self.create_publisher(
            UInt32, "/hope/v17/mocap/p1_marker_count", 10
        )
        self._pub_fresh = self.create_publisher(
            Bool, "/hope/v17/mocap/p1_marker_fresh", 10
        )
        self._pub_complete = self.create_publisher(
            Bool, "/hope/v17/mocap/p1_markers_complete", 10
        )
        self._pub_text = self.create_publisher(
            String, "/hope/v17/mocap/p1_marker_text", 10
        )
