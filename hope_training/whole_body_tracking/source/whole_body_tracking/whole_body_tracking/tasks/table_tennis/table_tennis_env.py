...
and applies the force at the full physics rate for accurate flight. If the callback cannot be registered
for any reason, the environment still runs — the ball just flies on PhysX gravity + contacts alone,
which is a valid (drag-free) scene.
"""
